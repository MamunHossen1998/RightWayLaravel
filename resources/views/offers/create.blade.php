                        ...
                        <div class="row">
                            <form action="{{ route('offers.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group image-preview">
                                    ...
                                    <img src="{{ asset(\App\Models\Offer::PLACEHOLDER_IMG_PATH) }}" alt="" height="150" width="150">
                                    <input type="file" id="offer_img" name="offer_img" class="image-upload-input form-control">
                                </div>
                                <div class="form-group">
